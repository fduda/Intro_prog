...
def natural_language_compute_mean(phrase):
    """
    This function recieves a phrase that informs the program two different numbers and what kind of mean to calculate.
    ...
    first_number = float(numbers_in_list[0]) # Creates a variable that stores the first element of the list above as the first number.
    second_number = float(numbers_in_list[1]) # Creates a variable that stores the second element of the list above as the second number.
